...
const addPropertiesToTocSections = (twFileContents, manual, sections) => {
...
export default function useGenerateTranslationWordsManuals({ catalogEntry, zipFileData }) {
