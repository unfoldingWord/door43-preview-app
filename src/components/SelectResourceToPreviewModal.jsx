...
export default function SelectResourceToPreviewModal({ canLoad, showModal, setShowModal }) {
  ...
  return (
    <Dialog open={showModal} onClose={() => setShowModal(false)} PaperComponent={PaperComponent} aria-labelledby="draggable-dialog-title">
      ...
      <DialogContent>
        {languages ? (
          <Autocomplete
            ...
            renderInput={(params) => <StyledTextField {...params} label="Language" variant="outlined" required />}
        ...
        {selectedLanguage && selectedLanguage.lc in owners ? (
          <Autocomplete
            ...
            renderInput={(params) => <StyledTextField {...params} label="Owner" variant="outlined" required />}
        ...
        {selectedOwner && selectedOwner.username in repos ? (
          <Autocomplete
            ...
            renderInput={(params) => <StyledTextField {...params} label="Repository" variant="outlined" required />}
        ...
        {selectedRepo ? (
          <FormControl>
            ...
            <RadioGroup aria-labelledby="ref-radio-buttons-group-label" value={refTypeChoice} name="ref-radio-buttons-group" onChange={handleRefTypeChange}>
              <div>
                {selectedRepo.catalog.latest ? (
                  <FormControlLabel value="latest" control={<Radio />} label={'Default Branch (' + selectedRepo.catalog.latest.branch_or_tag_name + ')'} />
                ) : (
                  ''
                )}
              ...
              <div>
                {selectedRepo.catalog.prod ? (
                  <FormControlLabel value="prod" control={<Radio />} label={'Latest Release (' + selectedRepo.catalog.prod.branch_or_tag_name + ')'} />
                ) : (
                  ''
                )}
      ...
      <DialogActions>
        ...
        <Button onClick={handleSelectResource} disabled={!selectedRepo}>
          Select
        </Button>
      </DialogActions>
    </Dialog>
