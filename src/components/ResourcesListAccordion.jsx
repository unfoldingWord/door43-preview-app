        ...
        <Accordion key={language.lc} onChange={(event, expanded) => handleLanguageAccordionChange(language, expanded)}>
          ...
          <AccordionDetails>
            {owners?.[language.lc]?.map((owner) => (
              <Accordion key={owner.id} onChange={(event, expanded) => handleOwnerAccordionChange(language, owner, expanded)}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                ...
                <AccordionDetails>
                  {topEntries?.[language.lc]?.[owner.username]?.map((topEntry) => (
                    <Accordion key={topEntry.name} onChange={(event, expanded) => handleTopEntryAccordionChange(topEntry, expanded)}>
                      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
